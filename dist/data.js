...
const NURIA = {
  ...
  photo: "assets/funsies/nuria_cutout.png",
...
const PROJECTS = [
  {
    ...
    de: {
      ...
      designCarousel: [
        { src: "assets/Portfolio_Content/Atolls_Glassdoor_Reviews/review_inbox.png", caption: "Review Inbox \u2014 KI klassifiziert jedes Review und schl\xE4gt eine Antwort im Atolls-Ton vor." },
        ...
        { src: "assets/Portfolio_Content/Atolls_Glassdoor_Reviews/edit.png", caption: "Approve oder editieren \u2014 Karla beh\xE4lt die finale Kontrolle \xFCber jede Antwort." },
        ...
        { src: "assets/Portfolio_Content/Atolls_Glassdoor_Reviews/distribution.png", caption: "Verteilung \u2014 Reviews nach Kategorie und Sentiment aufgeschl\xFCsselt." }
      ],
      ...
      researchGallery: [
        ...
        { src: "assets/Portfolio_Content/Atolls_Glassdoor_Reviews/journey_with.png", caption: "User Journey mit System \u2014 wo der KI-Agent unterst\xFCtzt und wo der Mensch entscheidet." },
        { src: "assets/Portfolio_Content/Atolls_Glassdoor_Reviews/team_photo.jpg", caption: "Das Team hinter dem Atolls Review Hub \u2014 HM M\xFCnchen." }
      ],
      research: [
  ...
  },
  {
    ...
    de: {
      ...
      problemGallery: [
        ...
        { src: "assets/Portfolio_Content/Echoes_of_Moosburg/process/Stalag-Moosburg.jpg", caption: "STALAG VII A \u2014 eines der gr\xF6\xDFten Kriegsgefangenenlager, kaum sichtbar in der Stadt." },
      ...
      designCarousel: [
        ...
        { src: "assets/Portfolio_Content/Echoes_of_Moosburg/outcome/b\xE4ckerei_tafel.jpg", caption: "QR-Guerrilla \u2014 Caf\xE9- und B\xE4ckerei-Tische als spontaner Discovery-Punkt" },
        { src: "assets/Portfolio_Content/Echoes_of_Moosburg/outcome/bank_qr.jpg", caption: "QR-Guerrilla \u2014 Parkbank als beil\xE4ufiger Discovery-Punkt" },
        { src: "assets/Portfolio_Content/Echoes_of_Moosburg/outcome/brosch\xFCre_seite1.png", caption: "Brosch\xFCre Seite 1 \u2014 zum Mitnehmen, Brand-System in Pergament-Beige & Rostrot", bare: true },
        { src: "assets/Portfolio_Content/Echoes_of_Moosburg/outcome/brosch\xFCre_seite2.png", caption: "Brosch\xFCre Seite 2 \u2014 Hub-\xDCbersicht aller Stadt-Ressourcen", bare: true }
      ],
      systemSlider: {
        ...
        images: [
          { src: "assets/Portfolio_Content/Echoes_of_Moosburg/outcome/stadt_tafel.png", caption: "Info-Stele am Marienplatz", text: "Der erste Kontakt: ein zentraler Anker mitten in der Stadt. QR-Code f\xFCr die App, Flyerfach f\xFCr alle ohne Smartphone \u2014 niemand wird ausgeschlossen." },
          { src: "assets/Portfolio_Content/Echoes_of_Moosburg/identity/brosch\xFCre_seite1B_web.jpg", caption: "Brosch\xFCre \u2014 zum Mitnehmen", text: "Wer lieber etwas in der Hand h\xE4lt, nimmt die Brosch\xFCre mit. Das Brand-System in Rostrot, Beige und Gr\xFCn macht die Geschichte greifbar.", bare: true },
          { src: "assets/Portfolio_Content/Echoes_of_Moosburg/identity/brosch\xFCre_seite_2B.png", caption: "Brosch\xFCre \u2014 der Hub auf Papier", text: "Seite zwei b\xFCndelt alle Stadt-Ressourcen auf einen Blick: VHS-Kurse, Vereinsf\xFChrungen, Museum, Schulprogramme \u2014 analog wie digital derselbe Hub.", bare: true },
          { src: "assets/Portfolio_Content/Echoes_of_Moosburg/outcome/museum_tafel.jpg", caption: "Echoes of Moosburg QR-Code im Museum", text: "Im Museum f\xFChrt der Echoes-of-Moosburg-QR-Code direkt zum jeweiligen Objekt \u2014 der Anker vor Ort schafft Vertrauen, die App liefert die Tiefe." },
          { src: "assets/Portfolio_Content/Echoes_of_Moosburg/outcome/system_konzept.png", caption: "Das System-Konzept", text: "So greifen die S\xE4ulen ineinander: physische Anker, digitale Tiefe und Partner-Institutionen werden zu einem lebendigen Netzwerk.", bare: true },
          { src: "assets/Portfolio_Content/Echoes_of_Moosburg/outcome/system_einwohner.png", caption: "Der Weg der Einwohner:innen", text: 'Und so erlebt es eine B\xFCrgerin \u2014 ein durchgehender Pfad von \u201EEntdecken" \xFCber \u201EVerstehen" bis \u201EWeitererz\xE4hlen".', bare: true }
        ],
    ...
    en: {
      ...
      designCarousel: [
        ...
        { src: "assets/Portfolio_Content/Echoes_of_Moosburg/outcome/b\xE4ckerei_tafel.jpg", caption: "Guerrilla QR \u2014 caf\xE9 and bakery tables as spontaneous discovery points" },
        ...
        { src: "assets/Portfolio_Content/Echoes_of_Moosburg/outcome/brosch\xFCre_seite1.png", caption: "Brochure page 1 \u2014 take-away piece, brand system in parchment beige & rust red", bare: true },
        { src: "assets/Portfolio_Content/Echoes_of_Moosburg/outcome/brosch\xFCre_seite2.png", caption: "Brochure page 2 \u2014 hub overview of all city resources", bare: true }
      ],
      systemSlider: {
        ...
        images: [
          ...
          { src: "assets/Portfolio_Content/Echoes_of_Moosburg/identity/brosch\xFCre_seite1B_web.jpg", caption: "Brochure \u2014 take it with you", text: "For people who would rather hold something, the brochure travels home. The brand system in rust red, beige and green makes the history tangible.", bare: true },
          { src: "assets/Portfolio_Content/Echoes_of_Moosburg/identity/brosch\xFCre_seite_2B.png", caption: "Brochure \u2014 the hub on paper", text: "Page two gathers every city resource at a glance: adult-ed courses, guided tours, the museum, school programs \u2014 the same hub, analog and digital.", bare: true },
  ...
  },
  {
    ...
    de: {
      ...
      appScreens: [
        { title: "Earn Tab", body: "Punkte-\xDCbersicht. Aktivit\xE4ten (Verkauf, Kauf, Game).", image: "assets/Portfolio_Content/VInted_Rebranding/reward_figur.png" },
        { title: "Game Tab", body: "T\xE4gliches Retro-Mini-Game. +10 Punkte pro Tag.", image: "assets/Portfolio_Content/VInted_Rebranding/vinti.png" },
  ...
  },
  {
    ...
    de: {
      ...
      /* ── Echoes-style sections — fill to enable (see echoes for the shape) ── */
      problemGallery: [
        { src: "assets/Portfolio_Content/Munich_Super_App/munich_seite.png", caption: "m\xFCnchen.de \u2014 Events & Aktivit\xE4ten liegen hier, komplett getrennt von Mobilit\xE4t (MVGO) und Tickets." },
        { src: "assets/Portfolio_Content/Munich_Super_App/apps_bundle.jpeg", caption: "App-Wildwuchs: 5+ Apps f\xFCr einen einzigen Vorgang." },
        { src: "assets/Portfolio_Content/Munich_Super_App/UserJourney1.png", caption: "User Journey ohne Super App \u2014 wo M\xFCnchner:innen Fristen, Tickets und \xDCberblick verlieren." }
      ],
      /* [{ src, caption }] → Problem as sticky-scroll gallery */
      designCarousel: [],
      /* [{ src, caption, bare }] → Solution as sticky-scroll */
      ...
      researchGallery: [
        ...
        { src: "assets/Portfolio_Content/Munich_Super_App/UserJourney1.png", caption: "Customer Journey \xFCber 5 Phasen \u2014 Before \xB7 During \xB7 After mit Pains/Gains." },
      ...
      media: [
        { type: "image", src: "assets/Portfolio_Content/Munich_Super_App/1000158730.jpg", caption: "Empathy Map \xB7 Personas-Skizze", width: 1200, height: 800 },
    ...
    en: {
      ...
      researchGallery: [
        ...
        { src: "assets/Portfolio_Content/Munich_Super_App/UserJourney1.png", caption: "Customer journey across 5 phases \u2014 Before \xB7 During \xB7 After with pains / gains." },
      ...
      media: [
        { type: "image", src: "assets/Portfolio_Content/Munich_Super_App/1000158730.jpg", caption: "Empathy map \xB7 personas sketch", width: 1200, height: 800 },
        { type: "image", src: "assets/Portfolio_Content/Munich_Super_App/1000158734.jpg", caption: "JTBD statement & 4 personas", width: 1200, height: 800 }
      ]
    }
  },
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    de: {
      ...
      researchImage: "",
      researchGallery: [
        { src: "assets/Portfolio_Content/Soulsphere_Bot/interview-research.png", caption: "Interview-Synthese (Before \xB7 During \xB7 After \xB7 Zukunft) \u2014 W\xFCnsche und Pains geclustert." },
      ...
      designCarousel: [
        { src: "assets/Portfolio_Content/Soulsphere_Bot/first-draft-process.png", caption: "Erster Entwurf \u2014 schlicht, nur ein Begr\xFC\xDFungsfeld, ohne Persona." },
    ...
    en: {
      ...
      researchImage: "",
      researchGallery: [
        { src: "assets/Portfolio_Content/Soulsphere_Bot/interview-research.png", caption: "Interview synthesis (Before \xB7 During \xB7 After \xB7 Future) \u2014 wishes and pains clustered." },
